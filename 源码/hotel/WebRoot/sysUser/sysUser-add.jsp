	...
	<html>
		...
		<body>
			<article class="page-container">
				<form action="${basePath}/sys/sysUser/save.action" method="post" class="form form-horizontal" id="form-member-add">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<input type="text" class="input-text" placeholder="" id="loginId" name="loginId" required>
						</div>
					</div>
					<div class="row cl">
