	...
	<body>
				...
				<tbody>
					<s:iterator value="list" var="c">
						<tr class="text-c">
							...
							<td class="td-manage"><a title="编辑" href="javascript:;" onclick="member_edit('编辑','${basePath}sys/vip/edit.action?id=<s:property value="#c.id"/>','4','800','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a></td>
						</tr>
					</s:iterator>
				</tbody>
			</table>
		...
		function member_del(id){
			layer.confirm('确认要删除吗？',function(){
				location.href="${basePath}/sys/vip/delete.action?id="+id;
			});
		}
		</script> 
	</body>
