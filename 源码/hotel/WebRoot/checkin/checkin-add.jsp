...
<article class="page-container">
	<form action="${basePath}/sys/checkin/addcheckin.action" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>房间名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<s:property value="#room.roomName" />" placeholder="" name="roomName" disabled="disabled" >
			</div>
		</div>
		<div class="row cl">
		...
		<input type="hidden" name="roomid" value="<s:property value="#room.id" />" />
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
